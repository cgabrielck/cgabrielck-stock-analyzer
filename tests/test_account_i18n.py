...
ACCOUNT_KEYS = {
    ...
    "options.position.title", "options.position.status", "options.position.state.watching_entry",
    "options.position.state.entry_alerted", "options.position.state.open", "options.position.state.closed",
    "options.position.state.stopped", "options.position.state.expired", "options.position.waiting_entry",
    "options.position.confirm_note", "options.position.entry_price", "options.position.quantity",
    "options.position.confirm", "options.position.opened",
